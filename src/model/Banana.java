...
/**
 * This class stores the details of a Banana Seed
 */
public class Banana extends Seed {
     ...
     */
    public Banana(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
