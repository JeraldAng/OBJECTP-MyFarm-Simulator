...
/**
 * This class stores the details of a Turnip Seed
 */
public class Turnip extends Seed {
     ...
     */
    public Turnip(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
