...
/**
 * This class stores the details of a Rose Seed
 */
public class Rose extends Seed{
     ...
     */
    public Rose(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
