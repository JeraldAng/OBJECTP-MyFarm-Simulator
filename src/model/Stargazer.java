...
/**
 * This class stores the details of a Stargazer Seed
 */
public class Stargazer extends Seed{
     ...
     */
    public Stargazer(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
