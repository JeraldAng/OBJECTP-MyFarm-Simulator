...
/**
 * This class stores the details of a Carrot Seed
 */
public class Carrot extends Seed{
     ...
     */
    public Carrot(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
