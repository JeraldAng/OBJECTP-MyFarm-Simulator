...
/**
 * This class stores the details of a Tomato Seed
 */
public class Tomato extends Seed{
     ...
     */
    public Tomato(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
