...
/**
 * This class stores the details of a Mango Seed
 */
public class Mango extends Seed {
     ...
     */
    public Mango(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
