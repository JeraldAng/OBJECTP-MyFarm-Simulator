...
/**
 * This class stores the details of a Potato Seed
 */
public class Potato extends Seed{
     ...
     */
    public Potato(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
