...
/**
 * This class stores the details of an Orange Seed
 */
public class Orange extends Seed{
     ...
     */
    public Orange(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
