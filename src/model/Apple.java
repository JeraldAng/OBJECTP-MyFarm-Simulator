...
/**
 * This class stores the details of an Apple Seed
 */
public class Apple extends Seed{
     ...
     */
    public Apple(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
