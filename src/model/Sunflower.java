...
/**
 * This class stores the details of a Sunflower Seed
 */
public class Sunflower extends Seed{
     ...
     */
    public Sunflower(String name, String type, String products, int cost, double harvestTime, int waterNeeded, int waterBonus,
